                ...
                <div className={styles.ItemsValuesDescriptionsContainer}>
                    ...
                    <div className={styles.ItemsValuesSecondContainer}>
                        <div className={styles.ItemsValuesSizeContainer}>
                            <p className={styles.ItemsValuesSize}>Размер</p>
                        </div>
                        <div className={styles.ItemsValuesPriceContainer}>
                            <p className={styles.ItemsValuesPrice}>Цена</p>
                        </div>
                        <div className={styles.ItemsValuesMarkContainer}>
                            <p className={styles.ItemsValuesMark}>Марка стали</p>
                        </div>
                        <div className={styles.ItemsValuesCountContainer}>
                            <p className={styles.ItemsValuesCount}>Количество</p>
                        </div>
            ...
            <div className={styles.ItemsList}>
                <div className={styles.FirstItem}>
                    ...
                    <div className={styles.FirstItemSecondContainer}>
                        <div className={styles.SizeContainerFirst}>
                            <p className={styles.ItemSize}>6</p>
                        </div>
                        <div className={styles.PriceContainer}>
                            <p className={styles.ItemPrice}>52000</p>
                        </div>
                ...
                <div className={styles.FirstItem}>
                    ...
                    <div className={styles.FirstItemSecondContainer}>
                        ...
                        <div className={styles.PriceContainer}>
                            <p className={styles.ItemPrice}>54000</p>
                        </div>
                        <div className={styles.MarkContainer}>
                            <p className={styles.ItemMark}>А500С</p>
                        </div>
                ...
                <div className={styles.FirstItem}>
                    ...
                    <div className={styles.FirstItemSecondContainer}>
                        ...
                        <div className={styles.PriceContainer}>
                            <p className={styles.ItemPrice}>55000</p>
                        </div>
                        <div className={styles.MarkContainer}>
                            <p className={styles.ItemMark}>А500С</p>
                        </div>
                ...
                <div className={styles.FirstItem}>
                    <div className={styles.FirstItemFirstContainer}>
                        <p className={styles.ItemTitle}>Арматура А3 д.18</p>
                    </div>
                    <div className={styles.FirstItemSecondContainer}>
                        <div className={styles.SizeContainerSecond}>
                            <p className={styles.ItemSize}>11,7</p>
                ...
                <div className={styles.FirstItem}>
                    ...
                    <div className={styles.FirstItemSecondContainer}>
                        ...
                        <div className={styles.PriceContainer}>
                            <p className={styles.ItemPrice}>53000</p>
                        </div>
                        <div className={styles.MarkContainer}>
                            <p className={styles.ItemMark}>А500С</p>
                        </div>
