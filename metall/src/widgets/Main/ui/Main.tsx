	...
	return (
		<div>
			<div className={style.container}>
				<img
					className={style.ImgMetall}
					src='./assets/metallchell1.png'
					alt='Metallchell1'
				/>
				<div className={style.contTxt}>
					<h3 className={style.Text}>
						Металлопрокат высочайшего качества
					</h3>
					<h2 className={style.H2Text}>
						Надежные поставки, оперативная доставка и
						гарантированное качество для вашего успешного проекта.
